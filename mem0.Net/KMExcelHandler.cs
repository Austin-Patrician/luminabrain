...
namespace mem0.Net
{
    public class KmExcelHandler : IPipelineStepHandler
    {
            ...
            ILogger<KmExcelHandler>? log = null)
        {
            ...
            _log = log ?? DefaultLogger<KmExcelHandler>.Instance;
            _tokenCounter = new TiktokenTokenizer("");
        }
            ...
            DataPipeline pipeline, CancellationToken cancellationToken = default)
        {
            ...
            foreach (DataPipeline.FileDetails uploadedFile in pipeline.Files)
            {
                             ...
                             .GeneratedFiles)
                {
                    ...
                    BinaryData partitionContent = await _orchestrator
                    ...
                    switch (file.MimeType)
                    {
                        case MimeTypes.PlainText:
                        {
                            ...
                            var excelList = content
                                .Split(KmsConstantcs.KMExcelSplit, StringSplitOptions.RemoveEmptyEntries).ToList();
                            sentences = excelList;
                    ...
                    for (int partitionNumber = 0; partitionNumber < partitions.Count; partitionNumber++)
                    {
                        ...
                        int tokenCount = _tokenCounter.CountTokens(text);
